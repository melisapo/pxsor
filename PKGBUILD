...
license=('MIT')
source=("pxsor.tar.gz::https://github.com/melisapo/pxsor/releases/download/v$pkgver/pxsor.tar.gz")
sha256sums=('c2ca119820450ec730180a96734cb50f02ca5453998fe568d145f70efba2eea6')
